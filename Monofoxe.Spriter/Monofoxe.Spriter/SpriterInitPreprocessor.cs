...
{
	public class SpriterInitPreprocessor
	{
		public virtual void Init(SpriterData spriter)
		{
		...
		private static void InitInfos(SpriterAnimation animation)
		{
			...
			{
				var file = animation.Entity.Spriter.Folders[info.FolderId].Files[info.FileId];

...
namespace Monofoxe.Spriter.Helpers
{
	internal static class MathHelper
	{
		...
		public static float Bezier2D(float x1, float y1, float x2, float y2, float t)
		{
			var duration = 1f;
			var cx = 3.0f * x1;
			var bx = 3.0f * (x2 - x1) - cx;
			var ax = 1.0f - cx - bx;
			var cy = 3.0f * y1;
			var by = 3.0f * (y2 - y1) - cy;
			var ay = 1.0f - cy - by;
